...
const Realtor_Email = () => {
  return (
    <div className='text-lg mt-12 ml-[100px] mr-[120px]'>
        ...
        <p className='mb-5'>I hope this email finds you well. My name is <span>
        <input
            type="text"
            style={{
                border: 'none',
        ...
        />and I recently came across your listing for the room available at
        <input
            type="text"
            style={{
                border: 'none',
        ...
        <p className='mb-5'>Your description of the room and its amenities perfectly matches what I'm looking for in my next home. The <span>
        <input
            type="text"
            style={{
                border: 'none',
        ...
        <p className='mb-5'>Allow me to tell you a little about myself - I am a dedicated student who values a quiet and conducive environment for studying <span>
        <input
            type="text"
            style={{
                border: 'none',
        ...
        <p className='mb-5'>Thank you for your consideration of my application. I look forward to the opportunity to discuss this further and hopefully make <span>
        <input
            type="text"
            style={{
                border: 'none',
