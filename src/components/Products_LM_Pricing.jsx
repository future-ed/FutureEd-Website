    ...
    <div className='w-full px-4 py-8 bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <p className='text-center text-4xl font-bold'>&lt;€24/uur</p>
              <div className='text-center font-medium'>
                  ...
                  <p className='py-2 border-b mx-8'>Totaal €424.99 pp</p>
                  <p className='py-2 border-b mx-8'>Betaling in termijnen mogelijk</p>
              </div>
          ...
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <p className='text-center text-4xl font-bold'>&lt;€22/uur</p>
              <div className='text-center font-medium'>
              <p className='py-2 border-b mx-8 mt-8'>Voor studenten</p>
                  <p className='py-2 border-b mx-8'>12 lessen in groep van 4</p>
                  <p className='py-2 border-b mx-8'>6 modules, 20 opdrachten</p>
                  <p className='py-2 border-b mx-8'>Wekelijks 1 online les van 1.5 uur</p>
                  <p className='py-2 border-b mx-8'>Totaal €394.99 pp</p>
                  <p className='py-2 border-b mx-8'>Betaling in termijnen mogelijk</p>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <div className='text-center font-medium'>
                  ...
                  <p className='py-2 border-b mx-8'>Prijs op aanvraag</p>
                  <p className='py-2 border-b mx-8'>Betaling in termijnen mogelijk</p>
              </div>
